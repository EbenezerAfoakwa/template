            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="side-menu-container">
                    <ul class="nav navbar-nav">
                        <li><a href="registration.php"><i class="fa-solid fa-window-restore fa-lg" style="margin-right: 3px;"></i></i>Resets</a></li>
                            ...
                            <div class="inbox">
                                ...
                                <div class="inbox-bx container-fluid">
                                    <div class="section" style="width: 100%;">
                                        <div class="inner">
                                            <form method="post" action="reg_sending.php" enctype="multipart/form-data">
                                                <h4 style="margin-top: -10px; font-weight:600; font-size:16px">PROFILE INFO</h4>

                                                <div class="bcolor2" style="display:flex; padding:8px 10px 8px 10px">
                                                    <label for="lname" style="padding-top: 10px;">Applicant Image:</label>
