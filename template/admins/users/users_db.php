...
?>
  ...
  <head>
    ...
    <link rel="stylesheet" href="users_db.css">
  ...
  <body style="width: 98%;">
      ...
      <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="side-menu-container">
          <ul class="nav navbar-nav">
            ...
            <li><a href="users_db.php"><i class="fa-brands fa-wpforms fa-lg" style="margin-right: 5px;"></i>Users_DB</a></li>
    ...
    <div class="mcw">
      ...
      <div align="center" style="margin-top: 80px;">
        ...
        <h4 style="font-size: 16px; font-weight:600; ">USERS RECORD</h4>
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  ...
                  <!-- <td>
                    <a href="users_db.php?id=<?php echo $row['id'] ?>"><i class="fa-solid fa-pen-to-square" style="color:#161e26c7"></i></a>
                    <a href="users_db.php?id=<?php echo $row['id'] ?>"><i class="fa-solid fa-trash-can" style="color:#161e26c7"></i></a>
                  </td> -->
                </tr>
